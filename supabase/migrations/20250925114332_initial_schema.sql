...
-- Migration created for Supabase CLI
...
-- Sample data section removed to prevent foreign key constraint errors
-- You can add sample data later through the dashboard or after creating test users
